...
CREATE TRIGGER SET_SUPPLIER_EMPLOYEE
BEFORE INSERT ON SUPPLIER
FOR EACH ROW
UPDATE SUPPLIER
SET E_ID < ALL ( SELECT E_ID FROM SUPPLIER GROUP BY E_ID HAVING COUNT(E_ID) = 
...
SELECT E_ID FROM SUPPLIER GROUP BY E_ID HAVING COUNT(E_ID) = (
	SELECT MIN(COUNT_E) FROM (SELECT COUNT(E_ID) AS COUNT_E FROM SUPPLIER GROUP BY E_ID) AS C
)
